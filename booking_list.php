                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                             ...
                             <td class="text-center">
                              <?php if($row['status'] == 1): ?>
                                <a href="/CabBooking-PHP/razorpay/razorpay">  <button type="button" class="btn btn-flat btn-info border btn-sm view_data" data-id="<?= $row['id'] ?>">Pay</button></a>
                             <?php endif; ?>
                                </td>
...
<script>
    $(function(){
        ...
        $('.pay_data').click(function(){
            uni_modal("Booking Details","indexrz.php?id="+$(this).attr('data-id'))
        })
    })
</script>